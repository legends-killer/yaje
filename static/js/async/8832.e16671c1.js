/*! For license information please see 8832.e16671c1.js.LICENSE.txt */
(self.webpackChunkyaje=self.webpackChunkyaje||[]).push([["8832"],{40147:function(e,t,a){"use strict";a.r(t),a.d(t,{conf:function(){return r},language:function(){return _}});var r={comments:{lineComment:"//",blockComment:["/*","*/"]},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"[",close:"]"},{open:"{",close:"}"},{open:"(",close:")"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"}]};function n(e){let t=[],a=e.split(/\t+|\r+|\n+| +/);for(let e=0;e<a.length;++e)a[e].length>0&&t.push(a[e]);return t}var o=n("true false"),i=n(`
			  alias
			  break
			  case
			  const
